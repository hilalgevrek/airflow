...
# airflow arayüzünden de çalıştırıp test edebiliriz. Aşağıdaki kod ile airflow CLI ile de test edebiliriz.
# airflow tasks test stock_market get_formatted_csv 2023-01-01
